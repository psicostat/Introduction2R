...
:::{.design title="R base vs RStudio" data-latex="[R base vs RStudio]"}
...
Prova a cambiare il tema dell editor in *Idle Fingers* per utilizzare uno sfondo scuro che affatichi meno la vista (vedi Figura seguente). Clicca su *RStudio > Preferenze > Appearance* (MacOS) o su *Tools > Options > Appearance (Windows)*.
