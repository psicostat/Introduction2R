...
:::{.trick title="\\texttt{rm(list=ls())}" data-latex="[\\texttt{rm(list=ls())}]"}
...
- **Utilizzare oggetti non ancora creati**. In questo caso l'errore è facilmente individuabile dato che sarà lo stesso R ad avvisarci che `object '<nome-oggetto>' not found`. In questo caso dovremmo semplicemente eseguire il comando per creare l'oggetto richiesto.
