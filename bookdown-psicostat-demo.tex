...
\tightlist
\item
  \textbf{Get started}. Una volta installato R ed R Studio, famiglierizzeremo con l'ambiennte di lavoro introducendo alcuni aspetti generali e le funzini principali. Verranno inoltre descritte alcune buone regole per iniziare una sessione di lavoro in R.
\item
...
\chapter{Primi Comandi in R}\label{first-commands}}
...
\hypertarget{part-get-started-1}{%
\part*{Get Started}\label{part-get-started-1}}
\addcontentsline{toc}{part}{Get Started}
