...
Calcola il risultato delle seguenti operazioni utilizzando R (\href{}{soluzioni}):
...
\item
  Nel caso della \textbf{disgiunzione inclusiva logica} \texttt{\textbar{}}, affinchè la proposizione sia vera è necessario che almeno una relaziona sia vera. La proposizione sarà valutarta falsa solo quando entrambe le relazioni sono false.
\end{itemize}
...
Esegui i seguenti esercizi utilizzando gli operatori relazionali e logici (\href{}{soluzioni}):
