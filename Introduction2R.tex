...
E possibile rinominare i livelli di un fattore utilizzando la funzione \texttt{levels()} quesa ci permette di accedere agli attuali livelli ed eventualmente ssostituirli.
...
\CommentTok{##  [1]  0.375483045  0.007881546  0.184683436  0.457343132  0.128117364}
\CommentTok{##  [6]  0.004316731 -0.279044610 -0.343590252  0.038928952  0.168865691}
\NormalTok{vec2 }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(vec2)}
\CommentTok{##  [1] -0.23504352  0.11710579  0.42825239 -0.27330895 -0.30707553  0.13634206}
\CommentTok{##  [7]  0.43973909  0.17258473 -0.09212456 -0.38647150}
\NormalTok{vec3 }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(vec3)}
\CommentTok{##  [1]  0.08137690  0.17385603  0.17503549  0.47734530 -0.31804391  0.08731763}
\CommentTok{##  [7] -0.03370439 -0.30430163 -0.29468320 -0.04419821}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##  [1]  0.30118454 -0.06641696  0.11038493  0.38304463  0.05381886 -0.06998177}
\CommentTok{##  [7] -0.35334311 -0.41788876 -0.03536955  0.09456719}
...
\KeywordTok{my_fun}\NormalTok{(vec1)}
\CommentTok{##  [1]  1.1952127 -0.2635673  0.4380486  1.5200641  0.2135733 -0.2777138}
\CommentTok{##  [7] -1.4021974 -1.6583386 -0.1403596  0.3752779}
\KeywordTok{my_fun}\NormalTok{(vec2)}
\CommentTok{##  [1] -0.7782383  0.3877418  1.4179603 -0.9049366 -1.0167390  0.4514339}
\CommentTok{##  [7]  1.4559933  0.5714348 -0.3050280 -1.2796222}
\KeywordTok{my_fun}\NormalTok{(vec3)}
\CommentTok{##  [1]  0.3187379  0.6809612  0.6855810  1.8696714 -1.2457179  0.3420067}
\CommentTok{##  [7] -0.1320137 -1.1918920 -1.1542185 -0.1731161}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##  [1]  0.27970039 -0.29559475 -0.35010756 -0.35677833  0.47367363  0.46216180}
\CommentTok{##  [7] -0.29476887  0.48389466 -0.04806907 -0.35411189}
\KeywordTok{trans_vec}\NormalTok{(vec, }\StringTok{"center_mean"}\NormalTok{)}
\CommentTok{##  [1]  0.27970039 -0.29559475 -0.35010756 -0.35677833  0.47367363  0.46216180}
\CommentTok{##  [7] -0.29476887  0.48389466 -0.04806907 -0.35411189}
\KeywordTok{trans_vec}\NormalTok{(vec, }\StringTok{"standardize"}\NormalTok{)}
\CommentTok{##  [1]  0.7353231 -0.7771089 -0.9204213 -0.9379585  1.2452724  1.2150082}
\CommentTok{##  [7] -0.7749377  1.2721432 -0.1263720 -0.9309485}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##  [1] -0.06218784  0.04085097 -0.31795912  0.26834550  0.03212795  0.34036917}
\CommentTok{##  [7]  0.21744515 -0.29556808 -0.39180500  0.16838131}
\KeywordTok{center_vec_median}\NormalTok{(vec)}
\CommentTok{##  [1] -0.098677304  0.004361508 -0.354448579  0.231856039 -0.004361508}
\CommentTok{##  [6]  0.303879709  0.180955693 -0.332057540 -0.428294461  0.131891849}
\KeywordTok{standardize_vec}\NormalTok{(vec)}
\CommentTok{##  [1] -0.2384730  0.1566521 -1.2192846  1.0290302  0.1232017  1.3052209}
\CommentTok{##  [7]  0.8338415 -1.1334212 -1.5024629  0.6456954}
\end{Highlighting}
\end{Shaded}
