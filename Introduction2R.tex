...
\begin{verbatim}
## [1]  5.261174  7.441567  7.477839  5.674228 11.343643
## [1]  5.261174  7.441567  7.477839  5.674228 11.343643
\end{verbatim}
...
\CommentTok{##  [1] -0.09402231  0.42517092  0.37417313  0.18950855 -0.35086958 -0.25391476}
\CommentTok{##  [7]  0.40192381 -0.05357145 -0.14918285  0.23746468}
\NormalTok{vec2 }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(vec2)}
\CommentTok{##  [1] -0.34111862 -0.08727491  0.02212662 -0.36426007 -0.06017391 -0.09656121}
\CommentTok{##  [7]  0.44638608 -0.31458637  0.35950256  0.43595982}
\NormalTok{vec3 }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(vec3)}
\CommentTok{##  [1]  0.215932645 -0.001990392 -0.098464153  0.473416708  0.173582705}
\CommentTok{##  [6] -0.457752860  0.302680369  0.376416270 -0.494614738 -0.489206553}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##  [1] -0.1666903  0.3525029  0.3015051  0.1168405 -0.4235376 -0.3265828}
\CommentTok{##  [7]  0.3292558 -0.1262395 -0.2218509  0.1647967}
...
\KeywordTok{my_fun}\NormalTok{(vec1)}
\CommentTok{##  [1] -0.5800043  1.2265450  1.0490966  0.4065504 -1.4737125 -1.1363551}
\CommentTok{##  [7]  1.1456560 -0.4392542 -0.7719371  0.5734152}
\KeywordTok{my_fun}\NormalTok{(vec2)}
\CommentTok{##  [1] -1.08620411 -0.27790439  0.07045652 -1.15989207 -0.19160826 -0.30747423}
\CommentTok{##  [7]  1.42140113 -1.00171902  1.14474302  1.38820141}
\KeywordTok{my_fun}\NormalTok{(vec3)}
\CommentTok{##  [1]  0.582353043 -0.005367927 -0.265549933  1.276766933  0.468138650}
\CommentTok{##  [6] -1.234522790  0.816304704  1.015164523 -1.333936321 -1.319350881}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##  [1] -0.14776368  0.04975941  0.45802603  0.25340582 -0.06405294 -0.27763832}
\CommentTok{##  [7]  0.07977773  0.12615072 -0.18511510 -0.29254966}
\KeywordTok{trans_vec}\NormalTok{(vec, }\StringTok{"center_mean"}\NormalTok{)}
\CommentTok{##  [1] -0.14776368  0.04975941  0.45802603  0.25340582 -0.06405294 -0.27763832}
\CommentTok{##  [7]  0.07977773  0.12615072 -0.18511510 -0.29254966}
\KeywordTok{trans_vec}\NormalTok{(vec, }\StringTok{"standardize"}\NormalTok{)}
\CommentTok{##  [1] -0.6137731  0.2066880  1.9025246  1.0525838 -0.2660598 -1.1532395}
\CommentTok{##  [7]  0.3313766  0.5239983 -0.7689214 -1.2151775}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##  [1] -0.2014597 -0.2782205 -0.1138061  0.3855533 -0.3918358 -0.3074471}
\CommentTok{##  [7]  0.2921689  0.4989311 -0.3880608  0.5041768}
\KeywordTok{center_vec_median}\NormalTok{(vec)}
\CommentTok{##  [1] -0.04382676 -0.12058763  0.04382676  0.54318617 -0.23420287 -0.14981420}
\CommentTok{##  [7]  0.44980178  0.65656396 -0.23042785  0.66180967}
\KeywordTok{standardize_vec}\NormalTok{(vec)}
\CommentTok{##  [1] -0.5369903 -0.7415963 -0.3033500  1.0276915 -1.0444375 -0.8194996}
\CommentTok{##  [7]  0.7787756  1.3298998 -1.0343752  1.3438822}
\end{Highlighting}
\end{Shaded}
