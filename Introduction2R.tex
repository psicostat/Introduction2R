...
\addcontentsline{toc}{subsubsection}{Struttura ifelse}
...
\hypertarget{utilizzi}{%
\subsubsection*{Utilizzi}\label{utilizzi}}
\addcontentsline{toc}{subsubsection}{Utilizzi}
...
\CommentTok{##      F   M}
\CommentTok{## 3 7.25 6.5}
\CommentTok{## 5 6.00 5.5}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{str}\NormalTok{(my_list)}
\CommentTok{## List of 3}
\CommentTok{##  $ sample_norm: num [1:10] -1.964 -1.448 1.019 -1.421 -0.605 ...}
\CommentTok{##  $ sample_unif: num [1:15] 0.546 0.409 0.961 0.662 0.365 ...}
\CommentTok{##  $ sample_pois: int [1:20] 8 6 6 6 6 4 4 1 8 5 ...}

\CommentTok{# Media }
\KeywordTok{lapply}\NormalTok{(my_list, }\DataTypeTok{FUN =}\NormalTok{ mean)}
\CommentTok{## $sample_norm}
\CommentTok{## [1] -0.8324701}
\CommentTok{## }
\CommentTok{## $sample_unif}
\CommentTok{## [1] 0.5621297}
\CommentTok{## }
...
\CommentTok{## }
\CommentTok{## $sample_norm}
\CommentTok{## [1] -0.9836134 -0.2519641 -1.0558786}
\CommentTok{## }
\CommentTok{## $sample_pois}
\CommentTok{## integer(0)}
...
\CommentTok{##  but FUN(X[[2]]) result is length 3}
...
\CommentTok{##  $ mean: num  0.00125 -0.28726 -0.19768 -0.46685 0.24827 ...}
\CommentTok{##  $ sd  : num  1.288 1.051 0.838 1.066 1.157 ...}
\KeywordTok{head}\NormalTok{(sample_info)}
\CommentTok{##           mean        sd}
\CommentTok{## 1  0.001247319 1.2877841}
\CommentTok{## 2 -0.287264181 1.0510169}
\CommentTok{## 3 -0.197681457 0.8377152}
\CommentTok{## 4 -0.466854627 1.0664321}
\CommentTok{## 5  0.248266127 1.1567373}
\CommentTok{## 6  0.438984975 0.8064642}
\end{Highlighting}
\end{Shaded}
