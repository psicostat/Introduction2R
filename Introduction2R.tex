...
\NormalTok{my_vector <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{6}\NormalTok{,}\DecValTok{8}\NormalTok{)}
...
\NormalTok{my_vector[}\DecValTok{4}\NormalTok{]}
\CommentTok{## [1] 8}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{my_vector[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{]}
\CommentTok{## Error in my_vector[1, 2, 3]: incorrect number of dimensions}

\CommentTok{# CORRETTA selezione più valori}
\NormalTok{my_vector[}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{)]}
\CommentTok{## [1] 2 4 6}
\NormalTok{my_vector[}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{]}
\CommentTok{## [1] 2 4 6}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{my_vector[}\DecValTok{10}\NormalTok{]}
\CommentTok{## [1] NA}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# ERRATA selezione più valori }
\NormalTok{my_vector[}\StringTok{"3"}\NormalTok{]}
\CommentTok{## [1] NA}

\CommentTok{# CORRETTA selezione più valori}
\NormalTok{my_vector[}\DecValTok{3}\NormalTok{]}
\CommentTok{## [1] 6}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_vector[}\FloatTok{2.2}\NormalTok{]}
\CommentTok{## [1] 4}
\NormalTok{my_vector[}\FloatTok{2.8}\NormalTok{]}
\CommentTok{## [1] 4}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my_vector[}\DecValTok{0}\NormalTok{]}
...
\NormalTok{numbers <-}\StringTok{ }\DecValTok{-5}\OperatorTok{:}\DecValTok{5}
\NormalTok{numbers[numbers }\OperatorTok{>=}\StringTok{ }\DecValTok{0}\NormalTok{]}
\CommentTok{## [1] 0 1 2 3 4 5}

\CommentTok{# Vettore caratteri - seleziono elemeni uguali a "bar"}
\NormalTok{words <-}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"foo"}\NormalTok{, }\StringTok{"bar"}\NormalTok{), }\DataTypeTok{times =} \DecValTok{4}\NormalTok{)}
\NormalTok{words[words }\OperatorTok{==}\StringTok{ "bar"}\NormalTok{]}
...
\tightlist
\item
  \textbf{Vettore logico} (vedi Capitolo TODO) - quando un vettore è valutato in una proposizione, R crea un nuovo vettore che contiene per ogni elemento del vettore iniziale la risposta (\texttt{TRUE} o \texttt{FALSE}) alla nostra proposizione.
\item
...
\NormalTok{condition <-}\StringTok{ }\NormalTok{words }\OperatorTok{==}\StringTok{ "bar"}
\NormalTok{condition}
\CommentTok{## [1] FALSE  TRUE FALSE  TRUE FALSE  TRUE FALSE  TRUE}

\CommentTok{# Selezione}
\NormalTok{words[condition]}
\CommentTok{## [1] "bar" "bar" "bar" "bar"}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{rimuovere-o-cambiare-lordine}{%
\subsection{Rimuovere o cambiare l'ordine}\label{rimuovere-o-cambiare-lordine}}
...
\hline
-0.02 & 0.14 & -0.65 & -1.53 & -1.27 & a\\
\hline
-0.88 & 0.87 & 0.20 & 1.69 & -1.45 & b\\
\hline
-1.31 & 0.84 & -0.25 & -0.51 & 0.41 & c\\
\hline
-1.23 & -0.39 & -0.29 & 0.85 & -0.68 & d\\
\hline
1.95 & -1.52 & -0.03 & -1.06 & 0.41 & e\\
\hline
-1.30 & -0.14 & -0.01 & 0.08 & -0.39 & f\\
\hline
-0.42 & 1.02 & 1.13 & -1.33 & -0.26 & g\\
\hline
-0.58 & -1.03 & -1.01 & 0.86 & -0.02 & h\\
\hline
-1.19 & -0.86 & -0.40 & 1.13 & -1.77 & i\\
\hline
-0.22 & -0.32 & -1.44 & -0.28 & 1.43 & j\\
\hline
\end{tabular}
\end{table}
