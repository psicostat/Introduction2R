...
\KeywordTok{class}\NormalTok{(my_words) }\CommentTok{# tipologia dati}
\CommentTok{## [1] "character"}
\end{Highlighting}
\end{Shaded}
...
Utilizzando le funzioni \texttt{sum()} e \texttt{mean()} con un vettore logico, possiamo valutare riuspettivamente il numero totale e la percentuale di elementi che hanno rispettato una certa condizione logica.
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{is.character}\NormalTok{(}\StringTok{"2021"}\NormalTok{)}
\CommentTok{## [1] TRUE}
\KeywordTok{is.character}\NormalTok{(}\DecValTok{2021}\NormalTok{)}
\CommentTok{## [1] FALSE}
\KeywordTok{is.character}\NormalTok{(2021L)}
\CommentTok{## [1] FALSE}
\KeywordTok{is.character}\NormalTok{(}\OtherTok{TRUE}\NormalTok{)}
\CommentTok{## [1] FALSE}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{is.numeric}\NormalTok{(}\StringTok{"2021"}\NormalTok{)}
\CommentTok{## [1] FALSE}
\KeywordTok{is.numeric}\NormalTok{(}\DecValTok{2021}\NormalTok{)}
\CommentTok{## [1] TRUE}
\KeywordTok{is.numeric}\NormalTok{(2021L)}
\CommentTok{## [1] TRUE}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{is.double}\NormalTok{(}\StringTok{"2021"}\NormalTok{)}
\CommentTok{## [1] FALSE}
\KeywordTok{is.double}\NormalTok{(}\DecValTok{2021}\NormalTok{)}
\CommentTok{## [1] TRUE}
\KeywordTok{is.double}\NormalTok{(2021L)}
\CommentTok{## [1] FALSE}
\KeywordTok{is.double}\NormalTok{(}\OtherTok{TRUE}\NormalTok{)}
\CommentTok{## [1] FALSE}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{is.integer}\NormalTok{(}\StringTok{"2021"}\NormalTok{)}
\CommentTok{## [1] FALSE}
\KeywordTok{is.integer}\NormalTok{(}\DecValTok{2021}\NormalTok{)}
\CommentTok{## [1] FALSE}
\KeywordTok{is.integer}\NormalTok{(2021L)}
\CommentTok{## [1] TRUE}
\KeywordTok{is.integer}\NormalTok{(}\OtherTok{TRUE}\NormalTok{)}
\CommentTok{## [1] FALSE}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{is.logical}\NormalTok{(}\StringTok{"2021"}\NormalTok{)}
\CommentTok{## [1] FALSE}
\KeywordTok{is.logical}\NormalTok{(}\DecValTok{2021}\NormalTok{)}
\CommentTok{## [1] FALSE}
\KeywordTok{is.logical}\NormalTok{(2021L)}
\CommentTok{## [1] FALSE}
...
Vediamo infine alcuni valori speciali che incontreremo spesso e che richiedono particolari accorgimenti: \texttt{NULL}, \texttt{NA}, \texttt{NaN}, \texttt{Inf}.
...
\hline
-0.43 & -1.43 & 0.39 & 2.00 & -0.05 & a\\
\hline
-0.64 & 0.18 & 2.28 & 0.01 & 0.71 & b\\
\hline
-0.44 & 2.31 & 0.53 & 0.75 & 0.18 & c\\
\hline
1.06 & -0.09 & 0.26 & -0.25 & -0.31 & d\\
\hline
-0.05 & -0.17 & 1.23 & -0.68 & -0.94 & e\\
\hline
1.02 & -0.81 & 0.37 & 0.60 & -0.50 & f\\
\hline
0.92 & -0.45 & 1.07 & -0.88 & -0.22 & g\\
\hline
-0.49 & -0.12 & -1.25 & 1.86 & 1.50 & h\\
\hline
-0.81 & 0.69 & 0.17 & -1.10 & -1.77 & i\\
\hline
1.39 & -0.21 & 0.25 & 1.80 & -0.03 & j\\
\hline
\end{tabular}
\end{table}
