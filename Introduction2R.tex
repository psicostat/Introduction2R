...
\CommentTok{##  [1] -0.1049188  0.4001664 -0.1866398 -0.4205324 -0.3595064 -0.4021132}
\CommentTok{##  [7] -0.1548789 -0.2910912 -0.2526912  0.2384372}
\NormalTok{vec2 }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(vec2)}
\CommentTok{##  [1] -0.25776839  0.15614830 -0.29499605 -0.27387888 -0.01529882  0.44457216}
\CommentTok{##  [7] -0.14438146  0.26141364 -0.05195010  0.17613960}
\NormalTok{vec3 }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(vec3)}
\CommentTok{##  [1]  0.39883351 -0.49066590  0.30530112  0.14364756 -0.04185578 -0.13234173}
\CommentTok{##  [7]  0.27755253  0.04020929 -0.11271003 -0.38797058}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##  [1]  0.048457994  0.553543264 -0.033262947 -0.267155618 -0.206129598}
\CommentTok{##  [6] -0.248736356 -0.001502031 -0.137714358 -0.099314334  0.391813985}
...
\KeywordTok{my_fun}\NormalTok{(vec1)}
\CommentTok{##  [1]  0.177875570  2.031900530 -0.122098858 -0.980652600 -0.756643368}
\CommentTok{##  [6] -0.913040708 -0.005513532 -0.505510399 -0.364554790  1.438238155}
\KeywordTok{my_fun}\NormalTok{(vec2)}
\CommentTok{##  [1] -1.02100865  0.61849621 -1.16846571 -1.08482160 -0.06059792  1.76092975}
\CommentTok{##  [7] -0.57188831  1.03544735 -0.20577193  0.69768081}
\KeywordTok{my_fun}\NormalTok{(vec3)}
\CommentTok{##  [1]  1.3593019 -1.6722845  1.0405254  0.4895787 -0.1426526 -0.4510462}
\CommentTok{##  [7]  0.9459528  0.1370410 -0.3841376 -1.3222789}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##  [1]  0.23483660 -0.23269195 -0.13745416  0.52635162 -0.29905071 -0.09780025}
\CommentTok{##  [7]  0.55656076 -0.23227754 -0.27045294 -0.04802143}
\KeywordTok{trans_vec}\NormalTok{(vec, }\StringTok{"center_mean"}\NormalTok{)}
\CommentTok{##  [1]  0.23483660 -0.23269195 -0.13745416  0.52635162 -0.29905071 -0.09780025}
\CommentTok{##  [7]  0.55656076 -0.23227754 -0.27045294 -0.04802143}
\KeywordTok{trans_vec}\NormalTok{(vec, }\StringTok{"standardize"}\NormalTok{)}
\CommentTok{##  [1]  0.7253384 -0.7187142 -0.4245538  1.6257391 -0.9236761 -0.3020750}
\CommentTok{##  [7]  1.7190458 -0.7174342 -0.8353463 -0.1483235}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{##  [1] -0.09665431 -0.10967926  0.28295999  0.14232430  0.22278332 -0.37292565}
\CommentTok{##  [7]  0.30652080 -0.11191023 -0.37462791  0.11120895}
\KeywordTok{center_vec_median}\NormalTok{(vec)}
\CommentTok{##  [1] -0.1039316 -0.1169566  0.2756827  0.1350470  0.2155060 -0.3802030}
\CommentTok{##  [7]  0.2992435 -0.1191876 -0.3819052  0.1039316}
\KeywordTok{standardize_vec}\NormalTok{(vec)}
\CommentTok{##  [1] -0.3842027 -0.4359770  1.1247711  0.5657417  0.8855677 -1.4823863}
\CommentTok{##  [7]  1.2184258 -0.4448452 -1.4891527  0.4420576}
\end{Highlighting}
\end{Shaded}
