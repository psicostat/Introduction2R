...
\hypertarget{selezione-per-riga-o-colonna}{%
\subsubsection*{Selezione per Riga o Colonna}\label{selezione-per-riga-o-colonna}}
\addcontentsline{toc}{subsubsection}{Selezione per Riga o Colonna}
...
\hypertarget{modificare-lordine-righe-e-colonne}{%
\subsubsection*{Modificare l'Ordine Righe e Colonne}\label{modificare-lordine-righe-e-colonne}}
\addcontentsline{toc}{subsubsection}{Modificare l'Ordine Righe e Colonne}
...
\subsection{Combinare Matrici}\label{combinare-matrici}}
...
Utilizzando le matrici \texttt{A} e \texttt{B} create nei precedenti esercizi:
