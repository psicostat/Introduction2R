...
\item
  \textbf{Capitolo \ref{first-comands}: Primi Passi in R}. Operatori matematici, operatori relazionali, operatori logici, creazione di variabili e utilizzo di funzioni.
\item
...
\item
  Definisci una proposizione per valutare la seguente condizione (ricordati di testare tutti i possibili scenari) ``\emph{x è un numero compreso -4 e -2 oppure è un numero compreso tra 2 e 4}''.
\item
