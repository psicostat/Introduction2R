...
In questa sezione verranno prima presentate le istruzioni per installare R ed RStudio. Successivamente, svolgeremo le prime oprazioni in R e familiarizzeremo con dei concetti di base della programmazioene quali gli oggetti e le funzioni. Introdurremmo infine altri concetti relativi alle sessioni di lavoro in R e descriveremo alcune buone regole per l'utilizzo di R.

I capitoli sono così organizzati:

- **Capitolo \@ref(install) - Installare R e RStudio**. Instruzioni passo passo per installare R e RStudio.
