...
x <- "stringa con all'interno un'altra "stringa""
# in questo caso abbaimo errore perché non interpreta la doppia virgolettatura
```
...
Queste funzioni sono estremamente utili perché permettono di forzare il carattere maiscolo o minuscolo
