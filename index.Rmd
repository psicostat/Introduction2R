...
- **Introduzione**. Una volta installato R ed R Studio, famiglierizzeremo con l'ambiennte di lavoro introducendo alcuni aspetti generali e le funzini principali. Verranno inoltre descritte alcune buone regole per iniziare una sessione di lavoro in R.
...
Se vuoi collaborare alla revione e sscrittura di questo libro (ovviamente è tutto in R) visita la nostra repository di Github https://github.com/psicostat/Introduction2R
